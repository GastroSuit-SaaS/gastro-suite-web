import { buildUpcomingReservations } from '../../../dashboard/presentation/helpers/dashboard-view.helpers.js';

/**
 * Alertas operativas para el POS Hub (datos ya disponibles en stores).
 */
export function buildPosHubAlerts({
    ...
    const upcoming = buildUpcomingReservations(reservationsStore?.activeReservations ?? [], 5);
