import { exportMultiSheetExcel } from '../../../shared/utils/excel-export.js';
import { MOVEMENT_TYPE_CONFIG, MOVEMENT_CATEGORY_CONFIG } from '../constants/cash-register.constants-ui.js';
...
function movementToRow(mov) {
    const typeLabel = MOVEMENT_TYPE_CONFIG[mov.type]?.label ?? mov.type;
    const categoryLabel = MOVEMENT_CATEGORY_CONFIG[mov.category]?.label ?? mov.category;
