# Documentación — gastro-suite-web

Índice de documentación técnica del frontend.
...
Al implementar cambios o cerrar ítems del plan:

1. Actualizar `ACTION-PLAN.md` (checkboxes) y detalle en `IMPLEMENTATION-PLAN.md` si cambia el enfoque.
2. Actualizar `INTEGRATION.md` si cambian endpoints consumidos.
3. Actualizar `KNOWLEDGE-BASE.md` en el repo API (Changelog).
4. Actualizar `TECHNICAL.md` si cambian módulos, rutas o convenciones.
